...
<?php echo $this->module->registerJs('jquery.dataTables.js', 'screen');?>  
<?php echo $this->module->registerJs('DT_bootstrap.js', 'screen');?> 
<?php echo $this->module->registerJs('dynamic-table.js', 'screen');?> 